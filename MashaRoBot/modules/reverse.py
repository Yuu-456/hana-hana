...
def reverse(update: Update, context:CallbackContext):
    ...
    try:
        ...
        if response != 400:
            xx = bot.send_message(chat_id,"Jab Tak Mai Reverse Kr Rha Hu Tbb Tak Tu Protecc Type Krle"
        ...
        xx.edit_text(f"[{guess}]({fetchUrl})\n[Tharak and waifu cheat help]({imgspage})", parse_mode='Markdown', disable_web_page_preview=True)
